...
var urlId = currentLocation.substr(1); //console.log("urlid",urlId)

fetch('../../data/photographers.json').then(function (response) {
  return response.json().then(function (data) {
    var uId = data.media;
    var datas = data.media; // console.log("urlid",uId)

    var datax = uId.find(function (ids) {
      return ids.photographerId === 243;
    }); //         console.log(datax);
